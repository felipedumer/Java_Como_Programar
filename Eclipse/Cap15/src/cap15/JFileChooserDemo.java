...
public class JFileChooserDemo extends JFrame {
	...
	// exibe inofrmações sobre o arquivo ou diretório que o usuário espeficicou
	...
	// permite que o usuário especifique  o nome de arqquivo ou diretório
	private Path getFileOrDirectoryPath()
	{
		// configura o diálogo permitindo a seleção deum arquivo ou diretóroi
		JFileChooser fileChooser = new JFileChooser();
		fileChooser.setFileSelectionMode(
				JFileChooser.FILES_AND_DIRECTORIES);
		int result = fileChooser.showOpenDialog(this);
		
		// se o usuário clicou no botão cancel no diálogo, retorno
