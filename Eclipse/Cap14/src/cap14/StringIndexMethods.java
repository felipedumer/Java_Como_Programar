...
public class StringIndexMethods {
	...
	public static void main(String[] args) {
		...
		// teta indexOf para localizar um caractere em uma string
		System.out.printf(
		...
		System.out.printf("Last 'a' is located at index %n%n", 
				letters.lastIndexOf('a', 25));
		System.out.printf("Last '$' is located at idnex %d%n%n", 
				letters.lastIndexOf('$'));
