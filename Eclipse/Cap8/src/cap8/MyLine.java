...
public class MyLine 
{
	private int x1; // coordenada x da primeira extermidade final
	private int y1; // coordenada y da primeira extremidade final
	private int x2; // coordenada x da segunda extermidade final
	private int y2; // coordenada y da segunda extremidade final
	private Color color; // atribui uma cor a essa lihna
