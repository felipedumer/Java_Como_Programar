...
{
	private Card[] deck; // array de objetos de Card
	private int currentCard; // índice da próxima Card a ser distribuída (0-5)
	...
	{
		// determina se ainda há Cards a serem distruibuídas
		if (currentCard < deck.length)
			return deck[currentCard++]; // retorna uma Card atual no array
		else
